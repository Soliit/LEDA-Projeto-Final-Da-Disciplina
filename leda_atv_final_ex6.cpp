...
void enfileirar(Noh_vinho *&inicio, Noh_vinho *&fim, string vinho, string origem, string uva, string safra) {
...
//FUNÇÃO - MARCA E INFORMA O VINHO NA FILA COMO RETIRADO EM UMA OCASIÃO ESPECIAL
...
void enfileirar_ocasiao(Noh_vinho_esp *&inicio, Noh_vinho_esp *&fim, string nome_vinho_esp){
